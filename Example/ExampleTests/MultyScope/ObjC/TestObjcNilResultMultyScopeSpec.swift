//
//  TestObjcNilResultMultyScopeSpec.swift
//  ExampleTests
//
...
private extension TestObjcNilResultMultyScopeSpec {

    // MARK: - Private functions

    func checkMultyScope(scope1: ResolverScopeProtocol, scope2: ResolverScopeProtocol) {
        describe("these will success multy scope \(scope1.referenceType)/\(scope2.referenceType) nil result") {
            ...
            checkObjcResolveNew(closure: { resolver in
                resolver.register(TestSimpleObjcClassProtocol.self, scope: scope1, factory: { _ in nil })
    ...
    func checkMultyScopeObjc(scope1: ResolverScopeProtocol, scope2: ResolverScopeProtocol) {
        describe("these will success multy scope \(scope1.referenceType)/\(scope2.referenceType) objc nil result") {
            checkObjcResolveNewAsObjcProtocol(closure: { resolver in
                resolver.register(protocol: TestSimpleObjcClassProtocol.self, scope: scope1, factory: { _ in nil })
            ...
            checkObjcResolveNewAsObjcClass(closure: { resolver in
                ...
                resolver.register(class: TestSimpleObjcClass.self, scope: scope1, factory: { _ in nil })
